...
export class ProjectsService {
  private projects = [{
    name: 'GymRatTrax',
    platform: 'Android via Java with SQLite',
    ...
    name: 'Hash It Out',
    platform: 'C#',
    availability: 'ClickOnce Install',
    availabilityLink: 'https://cjstone.net/hash-it-out/publish.htm',
    source: 'GitHub',
    link: 'https://github.com/christopher-stone/hash-it-out',
    ...
    name: 'Bookshop',
    platform: 'PHP with MySQL and HTML5',
